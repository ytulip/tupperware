...
<body>
<div class="container">
    <div style="position: fixed;left: 0;right: 0;height: 466px;background-image: url('/images/login_pic_nor@3x.png');background-size: cover;background-position: center center;background-repeat: no-repeat;">
    ...
    <div style="position: fixed;left: 0;right: 0;top:0;bottom: 0;">
        <form id="data_form" style="position:absolute;top: 117px;left: 50%;-webkit-transform: translateX(-50%);transform: translateX(-50%);background: #FFFFFF;box-shadow: 0 2px 12px 0 rgba(217,184,202,0.37);border-radius: 6px;padding: 53px 30px;">
            ...
            @if(strpos($_SERVER['SERVER_NAME'], 'apa') !== false )
                <div><img src="/images/apa{{(strpos($_SERVER['SERVER_NAME'], 'ppf') !== false )?'_ppf':''}}_logo.png" width="224px" attr_s="{{$_SERVER['SERVER_NAME']}}"/></div>
                @elseif(strpos($_SERVER['SERVER_NAME'], 'vkool') !== false )
                <div><img src="/images/vkool_logo.png" width="224px" attr_s="{{$_SERVER['SERVER_NAME']}}"/></div>
            @else
            ...
            <div style="width: 300px;margin-top: 24px;"><input style="padding: 14px;line-height: 20px;background: #FCFCFC;border: 1px solid #DEE3ED;border-radius: 3px;width: 100%;" placeholder="输入密码" type="password" name="password"/></div>

            <div style="width: 300px;margin-top: 40px;"><a class="t-al-c" style="display: inline-block;width: 100%;background: #E01885;box-shadow: 0 2px 8px 0 rgba(224,24,133,0.36);border-radius: 100px;line-height: 44px;font-size: 17px;color: #FFFFFF;letter-spacing: 0;" id="next_step">登录</a></div>
