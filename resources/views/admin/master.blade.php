...
{{--                 <li id="menu-academico"><a href="/admin/index/home" class="@if(!isset($block) || !$block) menu-a-active @endif"><i class="fa fa-envelope nav_icon menu-fa"></i><span>库存管理</span><div class="clearfix"></div></a></li>--}}
                ...
                <li id="menu-academico"><a href="/admin/index/classify" class="@if( isset($block) && ($block == 5)) menu-a-active @endif"><i class="fa fa-envelope nav_icon menu-fa"></i><span>产品系列</span><div class="clearfix"></div></a></li>
                ...
                <li id="menu-academico"><a href="/admin/index/dealer" class="@if( isset($block) && ($block == 8)) menu-a-active @endif"><i class="fa fa-envelope nav_icon menu-fa"></i><span>授权店管理</span><div class="clearfix"></div></a></li>
