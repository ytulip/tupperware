    ...
    <div class="sidebar-menu" style="box-shadow: none;border-right:1px solid #EAEEF7; ">
        ...
        <div class="menu">
            ...
            <ul id="menu" >
                ...
                <li id="menu-academico"><a href="/admin/index/records" class="@if( isset($block) && ($block == 1)) menu-a-active @endif"><i class="fa fa-envelope nav_icon menu-fa"></i><span>精选案例</span><div class="clearfix"></div></a></li>
