...
@section('container')
    ...
    <div style="padding: 0 24px;margin-top: 76px;">
        <div>
            <input placeholder="输入工号ID" style="display:inline-block;line-height: 44px;font-size: 17px;color: #93989E;letter-spacing: 0;background: #F7F7F9;border: 1px solid #EEEEEE;border-radius: 100px;width: 100%;text-align: center;box-sizing: border-box;"/>
        </div>
