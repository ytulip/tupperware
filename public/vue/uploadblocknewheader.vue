<template>
  <div>
    ...
    <div  style="height: 80px;border-radius: 4px;border: 1px solid #d9d9d9;display: inline-block;text-align: center;position: relative;width: 80px;overflow: hidden;cursor: pointer;" class="upload_block" :upload_src="value">
